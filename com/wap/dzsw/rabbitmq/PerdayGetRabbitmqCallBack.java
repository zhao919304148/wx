...
public class PerdayGetRabbitmqCallBack implements RabbitTemplate.ConfirmCallback{
	private static final String UPDATE_SQL="update perday_get_his set isqueue = ? where id = ? ;";
	@Autowired
